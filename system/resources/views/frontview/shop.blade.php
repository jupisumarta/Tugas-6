                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="{{url('shop')}}" class="logo">
                            <img  style="height: 65px; width: 120px;" src="{{url('public')}}/assets/images/jupi store.png">
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                        <li class="scroll-to-section"><a href="#top">Home</a></li>
                            ...
                            <li class="submenu">
                                ...
                                <li><a href="{{url('cart')}}">Single Produk</a></li>
                                </ul>
                            </li>
                ...
                <div class="col-lg-6">
                    <div class="left-content">
                        <div class="thumb">
                            ...
                            <img src="{{url('public')}}/assets/images/left-banner-image.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="{{url('public')}}/assets/images/baner-right-image-01.jpg">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="{{url('public')}}/assets/images/baner-right-image-02.jpg">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="{{url('public')}}/assets/images/baner-right-image-03.jpg">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="{{url('public')}}/assets/images/baner-right-image-04.jpg">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="owl-men-item owl-carousel">
                            ...
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{url('public')}}/assets/images/men-02.jpg" alt="">
                                </div>
                                <div class="down-content">
                                    <h4>Air Force 1 X</h4>
                                    <span>$90.00</span>
                            ...
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{url('public')}}/assets/images/men-03.jpg" alt="">
                                </div>
                                <div class="down-content">
                                    <h4>Love Nana ‘20</h4>
                                    <span>$150.00</span>
                        ...
                        <div class="owl-women-item owl-carousel">
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{url('public')}}/assets/images/women-01.jpg" alt="">
                                </div>
                                <div class="down-content">
                            ...
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{url('public')}}/assets/images/women-02.jpg" alt="">
                                </div>
                                <div class="down-content">
                                    <h4>Classic Dress</h4>
                                    <span>$45.00</span>
                            ...
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{url('public')}}/assets/images/women-03.jpg" alt="">
                                </div>
                                <div class="down-content">
                        ...
                        <div class="owl-kid-item owl-carousel">
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{url('public')}}/assets/images/kid-01.jpg" alt="">
                                </div>
                                <div class="down-content">
                            ...
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{url('public')}}/assets/images/kid-02.jpg" alt="">
                                </div>
                                <div class="down-content">
                                    <h4>Summer Cap</h4>
                                    <span>$12.00</span>
                            ...
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{url('public')}}/assets/images/kid-03.jpg" alt="">
                                </div>
                                <div class="down-content">
                                    <h4>Classic Kid</h4>
                                    <span>$30.00</span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="first-image">
                                    <img src="{{url('public')}}/assets/images/explore-image-01.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="second-image">
                                    <img src="{{url('public')}}/assets/images/explore-image-02.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="types">
            ...
            <div class="row images">
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{url('public')}}/assets/images/instagram-01.jpg" alt="">
                    </div>
                </div>
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{url('public')}}/assets/images/instagram-02.jpg" alt="">
                    </div>
                </div>
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{url('public')}}/assets/images/instagram-03.jpg" alt="">
                    </div>
                </div>
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{url('public')}}/assets/images/instagram-04.jpg" alt="">
                    </div>
                </div>
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{url('public')}}/assets/images/instagram-05.jpg" alt="">
                    </div>
                </div>
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{url('public')}}/assets/images/instagram-06.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
